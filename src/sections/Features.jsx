...
const Features = () => {
    return (
        <div className="p-10 bg-black text-white flex flex-col w-full">
            <h1 className='text-4xl font-bold font-filson tracking-widest'>FEATURES</h1>
            <div className="my-10 flex items-center justify-between border-[1px] border-slate-400 rounded-[10px] bg-gray-900 bg-opacity-75 font-roboto flex-col md:flex-row items-center justify-between">
                <img src={feature1} alt="Magic Wand" className="w-full h-full md:w-[45%] opacity-90" />
            ...
            <div className='flex w-full md:flex-row flex-col'>
                <div className="md:w-1/2 m-2 w-full my-10 flex items-center justify-between border-[1px] border-slate-400 rounded-[10px] bg-gray-900 bg-opacity-75 font-roboto flex-col items-center justify-between">
                    <img src={feature2} alt="Magic Wand" className="w-[60%] my-4 opacity-90" />
                    <div className="text-center flex flex-col justify-center md:text-left md:flex-1 p-8">
                        ...
                        <div className="flex flex-wrap w-full text-center justify-evenly items-center ">
                            <div style={{ '--bg': '#6600FF' }} className="smallicons flex w-full md:w-1/3 items-center p-2 rounded">
                                <img src={feature21} className="fas fa-magic text-purple-500 m-2" />
                                <span className='text-sm'>Real-time asset validation</span>
                            </div>
                            <div style={{ '--bg': '#00FFAB' }} className="smallicons flex w-full md:w-1/3 items-center p-2 rounded">
                ...
                <div className="md:w-1/2 m-2 w-full my-10 flex flex-col-reverse items-center justify-between border-[1px] border-slate-400 rounded-[10px] bg-gray-900 bg-opacity-75 font-roboto items-center justify-between">
                    <img src={feature3} alt="Magic Wand" className=" w-[60%] opacity-90 my-4" />
                    <div className="text-center flex flex-col justify-center md:text-left md:flex-1 p-8">
                        ...
                        <div className="flex w-full flex-wrap text-center justify-between items-center ">
                            ...
                            <div style={{ '--bg': '#E5E900' }} className="smallicons flex w-full md:w-1/3 items-center p-2 rounded">
            ...
            <div className="my-10 flex flex-col  items-center justify-between border-[1px] border-slate-400 rounded-[10px]">
                <div className="bg-gray-900  rounded-lg flex-1 bg-opacity-75 ">
                    <div className="flex font-roboto flex-col md:flex-row-reverse items-center justify-between">
                        <img src={feature4} alt="Magic Wand" className="w-full h-full md:w-[45%] opacity-90" />
                        <div className="text-center flex flex-col justify-center md:text-left md:flex-1 p-8">
